...
Then('I should see the default second header', function () {
    driver.findElement(By.xpath(`.//*[text()[contains(.,"I'll be checking for unique text values.")]]`))
})

Then('I should see the default third header', function () {
    driver.findElement(By.xpath(`.//*[text()[contains(.,"And confirming that I can change things.")]]`))
})
...
Then('I should change the text in the third header to {string}', function (string) {
